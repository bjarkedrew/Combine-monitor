...
void main() {
  testWidgets('MF 29 XP v0.3 dashboard golden at 1280x800', (tester) async {
    ...
    await expectLater(find.byKey(goldenKey), matchesGoldenFile('goldens/dashboard-v0.3.png'));
    controller.dispose();
